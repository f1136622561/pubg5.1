...
const apawnStyleFunc = function (feature) {
  ...
  var style = new ol.style.Style({
    ...
    text: new ol.style.Text({
      ...
      textAlign: 'center',
      fill: new ol.style.Fill({ color: 'rgba(5,5,5,0.9)' }),
...
const playerStyleFunc = function (feature) {
  var iconStyle = new ol.style.Style({
    ...
    text: new ol.style.Text({
      font: '12px Calibri,sans-serif',
      textAlign: 'center',
      fill: new ol.style.Fill({ color: 'rgba(5,255,5,1)' }),
      text: this.get('_label') || '' ,
      offsetY: 15
    })
  })
...
const itemStyleFunc = function (feature) {
  var style = new ol.style.Style({
    ...
    text: new ol.style.Text({
      ...
      text: this.get('_label') || '' ,
      offsetY: 12,
      stroke: new ol.style.Stroke({color: 'rgba(5,5,255,1)', width: 2.5 })
    })
  })
  return [style]
}
